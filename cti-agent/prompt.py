...
1. Delegating tasks to specialized agents like the RSS feed fetcher and feed cleaner
...
5. Present the cleaned and deduplicated entries to the user in a clear format

Important workflow notes:
- Always execute the steps in order: RSS Fetcher → Feed Cleaner (filter) → Feed Cleaner (dedupe) → Save → Present
